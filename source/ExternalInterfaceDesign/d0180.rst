...
*[The section describes architectural guidelines for integration to
systems outside the customers domain (external systems) and other
systems inside the customers domain (internal systems).]*
...
OS2iot using HTTPS in a request-response manner. Device management of
NB-IoT and Sigfox (i.e. adding and modifying IoT devices) are done by
sending requests to Telia's DCP platform and Sigfox's Cloud backend,
respectively.
...
*OS2iot supports managing NB-IoT devices using Telias network and DCP
platform (*\ https://api-portal.teliaiot.com/). For NB-IoT it is
important to distinguish between receiving data from devices and
managing devices.

The Telia DCP platform supports device operations such as:

-  Creating new devices

-  Updating existing devices

-  Requesting device data usage

NB-IoT devices communicate with the network using a SIM card or eUICC
(SIM card embedded into the device).

https://www.gsma.com/iot/wp-content/uploads/2018/04/NB-IoT_Deployment_Guide_v2_5Apr2018.pdf

https://www.telia.dk/globalassets/erhverv-new/2019/iot-burst-2/iot_vejledning.pdf

https://www.telia.dk/globalassets/erhverv-new/2018/iot/iot_rapport_dk.pdf

-  Service description (utilisation of the service)

-  Used in which use cases (who uses it)
...
-  Producer (who offers the integration point)

-  Response times (**how** fast does the service respond)

-  Error messages (which error messages can you expect from the service)

-  Contact information (who to contact in case of error)
